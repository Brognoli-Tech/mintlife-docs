...
- `<Callout icon="circle-check" iconType="regular">` for success confirmations
...
- Include verification steps with `<Callout icon="circle-check" iconType="regular">` components when relevant
